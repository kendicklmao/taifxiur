...
public class UserTest {
    ...
    @BeforeEach
    public void setUp() {
        bidder = new Bidder("bidder_user", "Password@123", "bidder@test.com", "What is your pet name?", "Fluffy",
                            "What is your mother's name?", "Jane");
        seller = new Seller("seller_user", "Password@123", "seller@test.com", "What is your pet name?", "Fluffy",
                           "What is your mother's name?", "Jane");
        admin = new Admin("admin_user", "Password@123", "admin@test.com", "What is your pet name?", "Fluffy",
                         "What is your mother's name?", "Jane");
    }
    ...
    public void testResetPasswordSuccess() {
        ...
        boolean result = bidder.resetPassword("Fluffy", "Jane", "NewPassword@456"); // Now reset password with correct answers
        assertTrue(result);
    ...
    public void testVerifySecurityAnswersCorrect() {
        boolean result = bidder.verifySecurityAnswers("Fluffy", "Jane"); // Test with exact answers provided during construction
