...
public abstract class User {
    ...
    private String answerSalt1;  //String ngẫu nhiên làm rối loạn mã hóa cho câu trả lời xác nhận danh tính 1
    private String answerSalt2; //String ngẫu nhiên làm rối loạn mã hóa cho câu trả lời xác nhận danh tính 2
    private String username; //tên tài khoản
    private String email; //email
    private boolean isBanned;//bị chặn hay không?
    private Role role; //loại tài khoản
    private String securityQuestion1; //câu hỏi xác nhận danh tính 1
    private String securityAnswer1; //câu trả lời xác nhận danh tính 1
    private String securityQuestion2;//câu hỏi xác nhận danh tính 2
    private String securityAnswer2; //câu trả lời xác nhận danh tính 2
