...
public class UserService {
    ...
    public boolean register(String username, String password, String email, String q1, String a1, String q2, String a2, Role role) { //đăng kí tài khoản
        ...
        User user;  //tao user & set vai tro
        if (role == Role.BIDDER) {
