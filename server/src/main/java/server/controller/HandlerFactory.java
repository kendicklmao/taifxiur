...
public class HandlerFactory {
    ...
    public static Map<String, RequestHandler> createHandlers(
        ...
        handlers.put("GET_PENDING_DEPOSIT_REQUESTS", new GetPendingDepositRequestsHandler(userService));
        handlers.put("GET_PENDING_WITHDRAW_REQUESTS", new GetPendingWithdrawRequestsHandler(userService));
        handlers.put("APPROVE_DEPOSIT_REQUEST", new ApproveDepositRequestHandler(userService));
        handlers.put("REJECT_DEPOSIT_REQUEST", new RejectDepositRequestHandler(userService));
        handlers.put("APPROVE_WITHDRAW_REQUEST", new ApproveWithdrawRequestHandler(userService));
        handlers.put("REJECT_WITHDRAW_REQUEST", new RejectWithdrawRequestHandler(userService));
        handlers.put("CREATE_DEPOSIT_REQUEST", new CreateDepositRequestHandler(userService));
        handlers.put("CREATE_WITHDRAW_REQUEST", new CreateWithdrawRequestHandler(userService));
        handlers.put("GET_WALLET_BALANCE", new GetWalletBalanceHandler(userService));
